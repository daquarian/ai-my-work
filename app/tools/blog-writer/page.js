    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="px-14 py-12 max-w-4xl">
        ...
        <p className="text-gray-500 mb-10">
          Generate SEO-ready blog posts that establish your authority and drive traffic.
        </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. 5 ways AI can help small businesses save time"
                  value={form.topic}
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. AI tools, small business automation"
                  value={form.keywords}
            ...
            {loading && (
              <div className="flex items-center justify-center h-48 text-gray-400">
                <div className="text-center">
                  ...
                  <p className="text-sm">Writing your article...</p>
                </div>
              </div>
            )}
            {!loading && !result && !error && (
              <div className="flex items-center justify-center h-48 text-gray-300 border-2 border-dashed border-gray-100 rounded-xl">
                <div className="text-center">
                  ...
                  <p className="text-sm">Your article will appear here</p>
                </div>
              </div>
            )}
            {result && (
