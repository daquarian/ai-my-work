  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="px-14 py-12 max-w-4xl">
        ...
        <p className="text-gray-500 mb-2">Paste any contract and get a plain-English breakdown in seconds.</p>
        <p className="text-xs text-gray-400 mb-10">Note: AI-generated summary for informational purposes only. Not legal advice.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white border border-gray-100 rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <textarea rows={12} required placeholder="Paste your contract text here..." value={contractText} onChange={(e) => setContractText(e.target.value)} className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-green-400 transition-colors resize-none"/>
              </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-8">
            ...
            {loading && <div className="flex items-center justify-center h-48 text-gray-400"><div className="text-center"><div className="text-3xl mb-3 animate-pulse">📄</div><p className="text-sm">Analyzing your contract...</p></div></div>}
            {!loading && !result && !error && <div className="flex items-center justify-center h-48 text-gray-300 border-2 border-dashed border-gray-100 rounded-xl"><div className="text-center"><div className="text-3xl mb-3">📄</div><p className="text-sm">Your summary will appear here</p></div></div>}
            {result && (
              <div>
