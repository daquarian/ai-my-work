    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="px-14 py-12 max-w-4xl">
        ...
        <p className="text-gray-500 mb-10">
          Generate a polished, persuasive business proposal in seconds.
        </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. Social media management for 3 months"
                  value={form.service}
              ...
              <div>
                ...
                <textarea
                  rows={3}
                  required
                  placeholder="e.g. They need to grow their social media presence and generate more leads online"
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="e.g. 3 months starting June 1"
                  value={form.timeline}
            ...
            {loading && (
              <div className="flex items-center justify-center h-48 text-gray-400">
                <div className="text-center">
                  ...
                  <p className="text-sm">Generating your proposal...</p>
                </div>
              </div>
            )}
            {!loading && !result && !error && (
              <div className="flex items-center justify-center h-48 text-gray-300 border-2 border-dashed border-gray-100 rounded-xl">
                <div className="text-center">
                  ...
                  <p className="text-sm">Your proposal will appear here</p>
                </div>
              </div>
            )}
            {result && (
